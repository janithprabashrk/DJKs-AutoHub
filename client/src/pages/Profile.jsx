      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            ...
            <span className="text-orange-500">Uploading {filePerc}%</span>
          ) : filePerc === 100 ? (
        ...
        <Link className="bg-green-500 text-white border p-3 rounded-lg text-center uppercase hover:opacity-95 disabled:opacity-80" to="/create-listing">
          Create Listing
        </Link>
      </form>
