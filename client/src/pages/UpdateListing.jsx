...
export default function UpdateListing() {
  ...
  return (
    <main className="min-h-screen bg-fixed bg-cover bg-center py-20" style={{backgroundImage: `linear-gradient(to bottom right, rgba(17, 24, 39, 0.9), rgba(31, 41, 55, 0.9)), url('https://images.unsplash.com/photo-1580310614729-ccd69652491d?q=80&w=2070&auto=format&fit=crop')`, backgroundAttachment: "fixed", backgroundBlendMode: "normal, overlay"}}>
      <div className="max-w-4xl mx-auto px-4 flex items-center justify-between mb-16">
        ...
        <h1 className="text-4xl text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Update Listing</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 flex items-center min-h-[calc(100vh-20rem)]">
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6 backdrop-blur-lg bg-white/10 p-8 rounded-2xl shadow-2xl w-full">
          ...
          <div className="relative w-full">
            ...
            <input type="number" min="0" placeholder="Regular Price" id="regularPrice" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 pl-14 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" required onChange={handleChange} value={formData.regularPrice} />
          ...
          <div className="relative w-full">
            <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">LKR :</span>
            <input type="number" min="0" placeholder="Discount Price" id="discountPrice" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 pl-14 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" onChange={handleChange} value={formData.discountPrice} />
            {formData.discountPrice < 0 && (
              <p className="absolute text-red-400 text-sm mt-1">Negative values are not allowed</p>
            )}
          </div>
          <input type="text" placeholder="Model Name" id="modelName" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.modelName} />
          <div className="relative w-full">
            <input type="number" min="0" placeholder="Year of Manufacture" id="YOM" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" required onChange={handleChange} value={formData.YOM} />
            {formData.YOM < 0 && (
              <p className="absolute text-red-400 text-sm mt-1">Negative values are not allowed</p>
            )}
          </div>
          <div className="flex gap-3 items-center px-2">
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" id="modified" className="sr-only peer" onChange={handleChange} checked={formData.modified} />
          ...
          <input type="text" placeholder="Type" id="Type" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.Type} />
          <input type="text" placeholder="Make" id="Make" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.Make} />
          <div className="relative w-full">
            <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">km :</span>
            <input type="number" min="0" placeholder="Mileage" id="Mileage" className="w-full bg-gray-800/50 border border-gray-700 rounded-xl p-4 pl-14 text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" required onChange={handleChange} value={formData.Mileage} />
            {formData.Mileage < 0 && (
              <p className="absolute text-red-400 text-sm mt-1">Negative values are not allowed</p>
            )}
          </div>
          ...
          <div className="relative w-full">
            <select id="fuelType" className="w-full appearance-none bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.fuelType}>
          ...
          <div className="relative w-full">
            <select id="condition" className="w-full appearance-none bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.condition}>
          ...
          <div className="relative w-full">
            <select id="Transmission" className="w-full appearance-none bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-transparent focus:outline-none transition-all duration-300 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)]" required onChange={handleChange} value={formData.Transmission}>
          ...
          {success && (
            <div className="col-span-2 bg-green-500/10 border border-green-500/20 rounded-lg px-4 py-2 text-green-400 text-center animate-fade-in">
              Listing Updated successfully! Redirecting in {redirectCountdown} seconds...
            </div>
          )}
          {error && (
