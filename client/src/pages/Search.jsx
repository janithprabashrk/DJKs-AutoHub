...
export default function Search() {
    ...
    return (
        <div className="min-h-screen">
            <main className="min-h-screen bg-fixed bg-cover bg-center pt-28 pb-20" 
                  style={{
                      backgroundImage: `linear-gradient(to bottom right, rgba(17, 24, 39, 0.9), rgba(31, 41, 55, 0.9)), 
